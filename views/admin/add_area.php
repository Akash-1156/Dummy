        ...
        <div class="card">
            ...
            <?php
                ...
                <form id="area_form" class="form-material" action="../process/dataProcess.php" method="POST" autocomplete="" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-default">
                        <input type="text" name="district" class="form-control" required="" data-parsley-trigger="keyup">
                        <span class="form-bar"></span>
                    ...
                    <div class="form-group form-default">
                        <input type="number" name="zip_code" class="form-control" required="" data-parsley-trigger="keyup">
                        <span class="form-bar"></span>
