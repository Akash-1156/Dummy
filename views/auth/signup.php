            ...
            <form id="validate_form" class="LgnForm max-w-xl mx-auto  shadow-lg bg-white rounded-lg pt-6 pb-8 mb-4 px-5" action="../process/dataProcess.php" method="POST" autocomplete="" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" apperance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="id" name="id" type="text" placeholder="Full Name" required="" data-parsley-trigger="keyup">
                    </div>
                    <!-- <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2">
                            ID
