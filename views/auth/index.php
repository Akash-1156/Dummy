				...
				<form id="login_form" action="../process/dataProcess.php" method="POST">
					...
					<div class="MskForm">
						...
						<div class="flex items-center justify-between">
							...
							<a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="../auth/f_email.php">
								Forgot Password?
							</a>
						</div>
						<p class="mt-2 text-black-500 text-xs">
							Don't have an account as user, <a href="signup.php" class="text-black-700 font-bold">Create an account</a>.
						</p>
